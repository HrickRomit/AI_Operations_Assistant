    ...
    <aside className={`sidebar ${isCollapsed ? "collapsed" : ""}`}>
      <div className="sidebar-header">
        <h2 className="sidebar-title">
          <svg className="sidebar-title-logo" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12 8C9.79 8 8 9.79 8 12C8 14.21 9.79 16 12 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            <circle cx="12" cy="12" r="1" fill="currentColor"/>
          </svg>
          <span className="sidebar-title-text">AI Ops</span>
        </h2>
      ...
      <nav className="sidebar-nav">
        ...
        <NavLink to="/email" className={linkClass}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
          <span className="link-text">Email Drafts</span>
        </NavLink>
        ...
        <NavLink to="/chat" className={linkClass}>
          ...
          <span className="link-text">Workflows</span>
        </NavLink>
